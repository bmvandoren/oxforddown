...
# Programmed and flexible: variation in migratory restlessness {#programmed-and-flexible}
...
```{r zug, out.width = "100%", message=F, echo=F}
pages <- list.files(file.path("pdf_chapters/zug"),pattern="zug_crop_Part",full.names = T)

knitr::include_graphics(pages)  
```


```{r zug-supp, out.width = "100%", message=F, echo=F}
