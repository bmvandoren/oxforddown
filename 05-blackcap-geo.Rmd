...
\chapter{Versatile migratory strategies and evolutionary insights revealed by\\tracks of wild Eurasian blackcaps}
\chaptermark{Versatile migratory strategies in blackcaps}
...
```{r blackcap-geo, child = '/Users/Benjamin/Documents/Oxford/Blackcaps/Blackcap_Geolocator_Analysis/blackcap_geo_comparative/scripts/Blackcap_geolocator_paper.Rmd'}
```
